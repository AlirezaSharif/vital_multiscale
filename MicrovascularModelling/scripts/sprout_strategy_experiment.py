...
def main():
    ...
    config.config_access["RUN_PARAMETERS"]["output_path"] = f"./outputs/SPROUT_STRAT_{strategy_num}"
    config.config_access["GROWTH_PARAMETERS"]["sprouting_strategy"] = strategy_num
