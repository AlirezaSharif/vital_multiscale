...
def main():
    ...
    output_strings = [f"./outputs/P_STRAT_{i}" for i in range(0, 4)]
    
    # Define maximum generation number (adjust as needed)
    max_gen = 9
    # Create an output directory if it doesn't exist
    output_dir = "./diagrams/pressure_strat"
    ...
    run_strings = [f"./outputs/P_STRAT_{i}" for i in range(0, 4)]
    ...
    def plot_attributes_over_generations(data_by_strat, output_dir):
        ...
        strategy_titles = ["Static Pressure", "Haemodynamic", "Metabolic", "Mixed"]
        ...
        for attribute in attributes:
            ...
            for strategy_i, gen_dataset in data_by_strat.items():
                ...
                plt.plot(gen_x, values, label=f"{strategy_titles[strategy_i]}", marker='o', color=colors[strategy_i])
    ...
    def plot_attributes_surface(data_by_strat, output_dir):
        ...
        strategy_ratios = np.array([key+1 for key in strategy_keys])  # use actual ratio values
        ...
        for attribute in attributes:
            ...
            num_ticks = 4  # or any number you prefer
    ...
    def plot_list_attribute_violin_subplots(data_by_strat, list_attributes, output_dir):
        ...
        for attribute in list_attributes:
            ...
            # ======== Per-Strategy View ========
            fig_strat, axes_strat = plt.subplots(nrows=2, ncols=2, figsize=(20, 5), sharey=True)
    ...
    def plot_blocky_violin_subplots(data_by_strat, list_attributes, output_dir, bins=20):
        ...
        for attribute in list_attributes:
            ...
            # === Per-Strategy View ===
            fig_strat, axes_strat = plt.subplots(nrows=2, ncols=2, figsize=(16, 8), sharey=True)
            axes_strat = axes_strat.flatten()
