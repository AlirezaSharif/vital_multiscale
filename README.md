...
```
## How does it work?
By running the following command in your Docker environment, arterial (```./artery```) and venous (```./vein```) trees inside a specified cube (***ex_3D.vtk***) will be generated with random seeds.
| ```./artery``` | ```./vein``` |
| :---: | :---: |
