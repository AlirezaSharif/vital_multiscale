...
int main(int argc, char *argv[])
{
    ...
    vascularise("ex1_simple3D_2", gam, delta, eta, n_draw, seed, N_fail, l_lim_fr, perfusion_area_factor, close_neighbourhood_factor, Delta_nu, theta_min);
